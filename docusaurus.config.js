...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: "/solution-forward-foundry/",


    // GitHub pages deployment config.
    // If you aren"t using GitHub pages, you don"t need these.
    organizationName: "ibm-client-engineering", // Usually your GitHub org/user name.
    projectName: "solution-forward-foundry", // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-forward-foundry/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-forward-foundry/edit/main/${blogDirPath}/${blogPath}",
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-forward-foundry",
